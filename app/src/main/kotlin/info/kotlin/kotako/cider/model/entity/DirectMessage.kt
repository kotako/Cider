...
class DirectMessage(
    ...
    constructor(id: Long, id_str: String, created_at: String, text: String,
            ...
            : this(id, id_str, created_at, text, User(sender), sender_id, sender_screen_name, User(recipient), recipient_id, recipient_screen_name)
